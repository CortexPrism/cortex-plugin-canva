...
Generate social media graphics, presentations, logos, and diagrams from natural language using
DALL-E, Stable Diffusion, and Canva.
...
- `style` (enum, default: "social") — Visual style: social, presentation, logo, diagram, photo,
  illustration
...
- `template_type` (enum, required) — Design type: instagram_post, facebook_post, presentation, logo,
  flyer, banner
